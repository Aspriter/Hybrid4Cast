...
class BACampaignEvaluator(object):
    ...
    def __init__(self, data_root, pp_datafile, use_transform='log'):
        ...
        self.hybrid_output_folder = os.path.join(self.data_root, 'hybridResult')
    ...
    @abc.abstractmethod
    def run_hybrid_model(self, etsfit_data, test_data):
        pass
...
def get_m4_category():
    ...
    # default input sample window size
    m4cat['window'] = [30, 40, 60, 60, 80, 168]
    # train stride
    m4cat['trastride'] = [6, 2, 3, 4, 4, 12]
    # long season decider threshold
